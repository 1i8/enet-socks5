...
public:
	...
	void SendPacketRaw(NetMessage type, const std::byte* data, size_t size) const noexcept {
	...
	void SendGenericText(const std::string& packet) const noexcept {
#ifndef NDEBUG
		std::cout
			<< ">--SendGenericText--<\n"
			<< packet
	...
	void SendGameMessage(const std::string& packet) const noexcept {
#ifndef NDEBUG
		std::cout
			<< ">--SendGameMessage--<\n"
			<< packet
	...
	void SendGamePacket(const GamePacket& packet) const noexcept {
#ifndef NDEBUG
		std::cout
			<< ">--SendGamePacket--<\n"
			<< packet
